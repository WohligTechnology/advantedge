...
<body class="sticky-header">
	...
	<div id="wrap">
                                    ...
                                    <li>
                                        ...
                                        <div class="sf-mega sf-mega-4-col">
											...
											<div class="sf-mega-section hidden-phone hidden-tablet">
                                                ...
                                                <p>
													<img src="assets/images/255x310.jpg" alt="">
												</p>
		...
		<!-- /// CONTENT  /////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
            ...
            <div class="container">
            	<div class="row">
                	<div class="span3">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectet ur adipiscing elit. Vestibulum bibend um vestibulum quam sit
                        amet consequ at. Donec in commodo elit.</p>
                    ...
                    <div class="span9">
                        ...
                        <ul class="services-list three-cols">
                        	<li>
                                ...
                                <div class="icon-box-6">
                                    ...
                                    <div class="icon-box-content">
                                        ...
                                        <p>Nulla ut semper augue, eget euismod quam quisque vel ligula.</p>
                            ...
                            <li>
                                ...
                                <div class="icon-box-6">
                                    ...
                                    <h3>
                                        <a href="single-service.html">Awards</a>
                                    </h3>

                                    <div class="icon-box-content">

                                        <p>Etiam mollis risus turpis, eu rutrum ipsum ornare et et leo.</p>
                            ...
                            <li>
                                ...
                                <div class="icon-box-6">
                                    ...
                                    <h3>
                                        <a href="single-service.html">Recognition</a>
                                    </h3>

                                    <div class="icon-box-content">

                                        <p>Nunc magna lorem, omis unde a rhoncus nec, commodo sed.</p>
                    ...
                    <div class="span4">
                        ...
                        <div class="icon-box-2">
                            ...
                            <div class="icon-box-content">
                                ...
                                <h2>
                                    <a href="single-service.html">Animated Slider</a>
                                </h2>

                                <p>Nulla ut semper augue, eget euismod quam. Quisque vel ligula nunc. Suspendisse eleifend massa molestie.</p>
                    ...
                    <div class="span4">
                        ...
                        <div class="icon-box-2">
                            ...
                            <div class="icon-box-content">
                                ...
                                <p>Suspendisse convallis erat nec orci eleifend, et aliquam ligula posuere. Duis sit amet libero id ligula vestibulum.</p>
                    ...
                    <div class="span4">
                        ...
                        <div class="icon-box-2">
                            ...
                            <div class="icon-box-content">
                                ...
                                <h2>
                                    <a href="single-service.html">Multiway use</a>
                                </h2>

                                <p>Augue, eget euismod quam. Quisque vel ligula nunc. Suspendisse eleifend massa molestie, viverra eros id.</p>
            ...
            <div class="info-box info-box-bg-right" id="info-box-1">

                <div class="info-box-img" style="background-image:url(content/backgrounds/960x800-1.jpg);">

                    <img src="content/backgrounds/960x800-1.jpg" alt="">
                ...
                <div class="container-fluid">
                	<div class="row">
                    	<div class="offset1 span4">
                            ...
                            <h1>Nulla ut semper augue, eget euismod quam. Quisque vel ligula nunc.</h1>

                            <br>

                            <h4>Nulla ut semper augue, eget euismod quam. Quisque vel ligula nunc. Suspendisse eleifend massa
                            molestie, viverra eros id, maximus arcu. Nullam nec turpis sit amet augue pretium gravida et vitae
                            purus. Suspendisse convallis erat nec orci eleifend et aliquam.</h4>

                            <br><br>

                            <div class="testimonial">

                                <img src="content/testimonials/95x95-1.jpg" alt="">
                	...
                	<div class="row">
                    	<div class="offset6 span6">
                            ...
                            <div class="box box-style-2">
                                ...
                                <h1>Aemper augue, <span class="text-highlight">eget euismod</span> quam quisque </h1>

                                <br>

                                <h4>Nulla ut semper augue, eget euismod quam. Quisque vel ligula nunc. Suspendisse eleifend massa
                                molestie, viverra eros id, maximus arcu.</h4>
                ...
                <div class="row">
                    ...
                    <div class="span4">
                        ...
                        <div class="icon-box-1">
                            ...
                            <div class="icon-box-content">
                                ...
                                <h3>
                                    <a href="single-service.html">Unlimited Choises</a>
                                </h3>

                                <p>Etiam mollis risus turpis, eu rutrum ipsum ornare et. Nullam et leo sem. Integer ultricies iaculis justo dolor.</p>
                    ...
                    <div class="span4">
                        ...
                        <div class="icon-box-1">
                            ...
                            <i class="ifc-update"></i>

                            <div class="icon-box-content">

                                <h3>
                                    <a href="single-service.html">Revolution Slider</a>
                                </h3>

                                <p>Praesent volutpat, eros a lobortis convallis, neque tortor condimentum lectus, nec pharetra justo arcu id arcu.</p>
                ...
                <div class="row">
                    <div class="span4">
                        ...
                        <div class="icon-box-1">
                            ...
                            <div class="icon-box-content">
                                ...
                                <p>Cras scelerisque efficitur erat, quis luctus erat vestibulum ac. Vivamus scelerisque volutpat nibh, id facilisis.</p>
                    ...
                    <div class="span4">
                        ...
                        <div class="icon-box-1">
                            ...
                            <div class="icon-box-content">
                                ...
                                <h3>
                                    <a href="single-service.html">Fresh design</a>
                                </h3>

                                <p>Vivamus fringilla ex et nunc tempor malesuada. Cras finibus sem purus, quis suscipit lacus imperdiet nec.</p>
                    ...
                    <div class="span4">
                        ...
                        <div class="icon-box-1">
                            ...
                            <i class="ifc-flash_light"></i>

                            <div class="icon-box-content">

                                <h3>
                                    <a href="single-service.html">Icon boxes</a>
                                </h3>

                                <p>Phasellus eu metus venenatis, porta arcu ac, mattis lectus. Curabitur placerat elementum tellus a volutpat.</p>
                    ...
                    <div class="span4">
                        ...
                        <div class="icon-box-1">
                            ...
                            <div class="icon-box-content">
                                ...
                                <h3>
                                    <a href="single-service.html">+100 build pages</a>
                                </h3>

                                <p>Vivamus quis sem mollis, pretium quam eu, malesuada nisl. Phasellus pharetra velit iaculis, ornare purus id.</p>
                    ...
                    <div class="span4">
                        ...
                        <div class="icon-box-1">
                            ...
                            <div class="icon-box-content">
                                ...
                                <p>Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus suspendisse.</p>
                    ...
                    <div class="span4">
                        ...
                        <div class="icon-box-1">
                            ...
                            <div class="icon-box-content">
                                ...
                                <h3>
                                    <a href="single-service.html">Business &amp; Creative</a>
                                </h3>

                                <p>Suspendisse luctus enim vitae tortor facilisis eleifend. Donec sit amet lacus id enim varius pretium sed amet.</p>
                            ...
                            <div class="span12">
                                ...
                                <div class="portfolio-filter">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="#" data-filter=".term-1">Photography</a>
                                        </li>
                                        <li>
                                            <a href="#" data-filter=".term-2">Industrial Design</a>
                                        </li>
                                        <li>
                                            <a href="#" data-filter=".term-3">Corporate</a>
                                        </li>
                                        <li>
                                            <a href="#" data-filter=".term-4">Architecture</a>
                                        </li>
                                    </ul>
                    ...
                    <div class="container-fluid">
                    	<div class="row">
                        	<div class="offset1 span10">
                            	...
                            	<div class="portfolio-grid portfolio-isotope">

                                    <div class="item width-1 term-2">

                                        <div class="portfolio-item">

                                            <div class="portfolio-item-preview">

                                                <img src="content/portfolio/315x290-1.jpg" alt="">

                                                <div class="portfolio-item-overlay">

                                                    <div class="portfolio-item-overlay-actions">

                                                        <a class="portfolio-item-zoom magnificPopup-gallery" href="content/portfolio/315x290-1.jpg">+</a>
                                                    ...
                                                    <div class="portfolio-item-description">
                                                        ...
                                                        <h3>
                                                            <a href="portfolio-single.html">Corporate Identity</a>
                                                        </h3>

                                                        <h6>Design, Photography</h6>
                                    ...
                                    <div class="item width-1 term-3">

                                        <div class="portfolio-item">

                                            <div class="portfolio-item-preview">

                                                <img src="content/portfolio/315x580-1.jpg" alt="">

                                                <div class="portfolio-item-overlay">

                                                    <div class="portfolio-item-overlay-actions">

                                                        <a class="portfolio-item-zoom magnificPopup-gallery" href="content/portfolio/315x580-1.jpg">+</a>
                                    ...
                                    <div class="item width-1 term-1 term-4">

                                        <div class="portfolio-item">

                                            <div class="portfolio-item-preview">

                                                <img src="content/portfolio/315x290-2.jpg" alt="">

                                                <div class="portfolio-item-overlay">

                                                    <div class="portfolio-item-overlay-actions">

                                                        <a class="portfolio-item-zoom magnificPopup-gallery" href="content/portfolio/315x290-2.jpg">+</a>
                                                    ...
                                                    <div class="portfolio-item-description">
                                                        ...
                                                        <h3>
                                                            <a href="portfolio-single.html">3D Printing</a>
                                                        </h3>
                                    ...
                                    <div class="item width-1 term-3">
                                        ...
                                        <div class="portfolio-item">
                                            ...
                                            <div class="portfolio-item-preview">
                                                ...
                                                <img src="content/portfolio/315x290-3.jpg" alt="">

                                                <div class="portfolio-item-overlay">

                                                    <div class="portfolio-item-overlay-actions">

                                                        <a class="portfolio-item-zoom magnificPopup-gallery" href="content/portfolio/315x290-3.jpg">+</a>
                                                    ...
                                                    <div class="portfolio-item-description">
                                                        ...
                                                        <h3>
                                                            <a href="portfolio-single.html">Product Identity</a>
                                                        </h3>
                                    ...
                                    <div class="item width-1 term-1 term-2 term-3">

                                        <div class="portfolio-item">

                                            <div class="portfolio-item-preview">

                                                <img src="content/portfolio/315x290-4.jpg" alt="">

                                                <div class="portfolio-item-overlay">

                                                    <div class="portfolio-item-overlay-actions">

                                                        <a class="portfolio-item-zoom magnificPopup-gallery" href="content/portfolio/315x290-4.jpg">+</a>
                                                    ...
                                                    <div class="portfolio-item-description">
                                                        ...
                                                        <h3>
                                                            <a href="portfolio-single.html">Corporate Branding</a>
                                                        </h3>
                                    ...
                                    <div class="item width-2 term-2 term-4">

                                        <div class="portfolio-item">

                                            <div class="portfolio-item-preview">

                                                <img src="content/portfolio/630x290-1.jpg" alt="">

                                                <div class="portfolio-item-overlay">

                                                    <div class="portfolio-item-overlay-actions">

                                                        <a class="portfolio-item-zoom magnificPopup-gallery" href="content/portfolio/630x290-1.jpg">+</a>
                                                    ...
                                                    <div class="portfolio-item-description">
                                                        ...
                                                        <h3>
                                                            <a href="portfolio-single.html">Business Cards</a>
                                                        </h3>
                                    ...
                                    <div class="item width-1 term-4">

                                        <div class="portfolio-item">

                                            <div class="portfolio-item-preview">

                                                <img src="content/portfolio/315x290-5.jpg" alt="">

                                                <div class="portfolio-item-overlay">

                                                    <div class="portfolio-item-overlay-actions">

                                                        <a class="portfolio-item-zoom magnificPopup-gallery" href="content/portfolio/315x290-5.jpg">+</a>
                                                    ...
                                                    <div class="portfolio-item-description">
                                                        ...
                                                        <h3>
                                                            <a href="portfolio-single.html">Mock-up Design</a>
                                                        </h3>
                                    ...
                                    <div class="item width-1 term-1 term-3">

                                        <div class="portfolio-item">

                                            <div class="portfolio-item-preview">

                                                <img src="content/portfolio/315x290-6.jpg" alt="">

                                                <div class="portfolio-item-overlay">

                                                    <div class="portfolio-item-overlay-actions">

                                                        <a class="portfolio-item-zoom magnificPopup-gallery" href="content/portfolio/315x290-6.jpg">+</a>
                                    ...
                                    <div class="item width-2 term-1 term-3">

                                        <div class="portfolio-item">

                                            <div class="portfolio-item-preview">

                                                <img src="content/portfolio/630x290-2.jpg" alt="">

                                                <div class="portfolio-item-overlay">

                                                    <div class="portfolio-item-overlay-actions">

                                                        <a class="portfolio-item-zoom magnificPopup-gallery" href="content/portfolio/630x290-2.jpg">+</a>
                                                    ...
                                                    <div class="portfolio-item-description">
                                                        ...
                                                        <h3>
                                                            <a href="portfolio-single.html">Book for kids</a>
                                                        </h3>
                                    ...
                                    <div class="item width-1 term-4">
                                        ...
                                        <div class="portfolio-item">
                                            ...
                                            <div class="portfolio-item-preview">
                                                ...
                                                <img src="content/portfolio/315x290-7.jpg" alt="">

                                                <div class="portfolio-item-overlay">

                                                    <div class="portfolio-item-overlay-actions">

                                                        <a class="portfolio-item-zoom magnificPopup-gallery" href="content/portfolio/315x290-7.jpg">+</a>
                                    ...
                                    <div class="item width-1 term-2 term-3">

                                        <div class="portfolio-item">

                                            <div class="portfolio-item-preview">

                                                <img src="content/portfolio/315x290-8.jpg" alt="">

                                                <div class="portfolio-item-overlay">

                                                    <div class="portfolio-item-overlay-actions">

                                                        <a class="portfolio-item-zoom magnificPopup-gallery" href="content/portfolio/315x290-8.jpg">+</a>
                                    ...
                                    <div class="item width-1 term-3">
                                        ...
                                        <div class="portfolio-item">
                                            ...
                                            <div class="portfolio-item-preview">
                                                ...
                                                <img src="content/portfolio/315x290-9.jpg" alt="">

                                                <div class="portfolio-item-overlay">

                                                    <div class="portfolio-item-overlay-actions">

                                                        <a class="portfolio-item-zoom magnificPopup-gallery" href="content/portfolio/315x290-9.jpg">+</a>
                    ...
                    <div class="container">
                    	<div class="row">
                        	<div class="offset6 span6">
                            	...
                            	<h3 class="text-uppercase"><strong>Some extra features</strong></h3>

                                <br>

                                <p>Nulla ut semper augue, eget euismod quam. Quisque vel ligula nunc. Suspendisse eleifend massa
                                molestie, viverra eros id, maximus arcu. Nullam nec turpis sit amet augue pretium gravida et vitae
                                purus. Suspendisse convallis erat nec orci eleifend.</p>

                                <br>

                                <ul class="arrow">
                                    <li>Aliquam libero augue, porttitor at</li>
                                    <li>Maecenas ac imperdiet libero fusce</li>
                                    <li>Sed semper suscipit sollicitudin eros</li>
                                    <li>Quisque consectetur efficitur sodales</li>
                                </ul>
                    ...
                    <div class="container">
                    	<div class="row">
                        	<div class="span3">
                            	...
                            	<div class="pie-chart" data-percent="90" data-barColor="#85c334" data-trackColor="transparent" data-lineWidth="9" data-barSize="220">
                                    ...
                                    <span class="pie-chart-custom-text">Html &amp; Css</span>
                            ...
                            <div class="span3">
                            	...
                            	<div class="pie-chart" data-percent="75" data-barColor="#85c334" data-trackColor="transparent" data-lineWidth="9" data-barSize="220">
                                    ...
                                    <span class="pie-chart-custom-text">Design</span>
                            ...
                            <div class="span3">
                            	...
                            	<div class="pie-chart" data-percent="60" data-barColor="#85c334" data-trackColor="transparent" data-lineWidth="9" data-barSize="220">
                                    ...
                                    <span class="pie-chart-custom-text">Php</span>
                    	...
                    	<div class="row">
                        	<div class="span12">
                                ...
                                <ul class="clients-logos">
                                	<li style="background-image:url(content/clients-logos/150x200-1.png);"></li>
                                    <li style="background-image:url(content/clients-logos/150x200-2.png);"></li>
                                    <li style="background-image:url(content/clients-logos/150x200-3.png);"></li>
                                    <li style="background-image:url(content/clients-logos/150x200-4.png);"></li>
                                    <li style="background-image:url(content/clients-logos/150x200-5.png);"></li>
                                </ul>
                    ...
                    <div class="container">
                    	<div class="row">
                        	<div class="span12">
                                ...
                                <h2 class="no-margin-bottom text-center"><strong>Suspendisse efficitur nec felis non luctus. Proin quis enim et est mattis placerat.</strong></h2>
                ...
                <div class="row">
                    <div class="span4">
						...
						<div class="post format-standard has-post-thumbnail hentry">
                            ...
                            <a href="blog-post.html" class="post-thumbnail">
								<img src="content/blog/360x290-1.jpg" alt="" >
							</a>
                    ...
                    <div class="span4">
						...
						<div class="post format-standard has-post-thumbnail hentry">
                            ...
                            <a href="blog-post.html" class="post-thumbnail">
								<img src="content/blog/360x290-2.jpg" alt="" >
							</a>
                    ...
                    <div class="span4">
						...
						<div class="post format-standard has-post-thumbnail hentry">
                            ...
                            <a href="blog-post.html" class="post-thumbnail">
								<img src="content/blog/360x290-3.jpg" alt="" >
							</a>
            ...
            <div class="fullwidth-section parallax custom-color-selected" id="bg-6">
                    ...
                    <div class="container">
                    	<div class="row">
                        	<div class="span12 text-center">
                                ...
                                <h1 class="text-uppercase"><strong>Get it now</strong></h1>

                                <br>

                                <h3><strong>Suspendisse efficitur nec felis non luctus. Proin quis enim et est mattis placerat.
                                Aliquam at justo ut est gravida tincidunt</strong></h3>
